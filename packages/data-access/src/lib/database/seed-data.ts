...
export const seedEventTypes: EventTypeDocument[] = [
  ...
  },
  {
    ...
    category: EventCategoryType.Outcome,
    targetStatus: RoleStatus.OfferAccepted,
    isSystemDefined: true,
    isCommon: false,
  },
  {
  ...
  {
    id: '4b3c2d1e-0f9a-8b7c-6d5e-4f3e2d1c0b9a',
    serverId: null,
    updatedAt: new Date().toISOString(),
    name: 'No Response / Ghosted',
    translationKey: 'ghosted',
    category: EventCategoryType.Outcome,
    targetStatus: RoleStatus.Ghosted,
    isSystemDefined: true,
    isCommon: false,
  },
];
